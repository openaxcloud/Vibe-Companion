// AUTO-EXTRACTED from server/routes.ts (lines 2620-2679)
// Original section: keyboard-shortcuts
...
export async function registerKeyboardShortcutsRoutes(app: Express, ctx: any): Promise<void> {
  const {
