// AUTO-EXTRACTED from server/routes.ts (lines 11745-11790)
// Original section: connector-proxy
...
export async function registerConnectorProxyRoutes(app: Express, ctx: any): Promise<void> {
  const {
