// AUTO-EXTRACTED from server/routes.ts (lines 3857-3897)
// Original section: system-dependencies
...
export async function registerSystemDependenciesRoutes(app: Express, ctx: any): Promise<void> {
  const {
