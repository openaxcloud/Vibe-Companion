// AUTO-EXTRACTED from server/routes.ts (lines 3997-4019)
// Original section: visibility
...
export async function registerVisibilityRoutes(app: Express, ctx: any): Promise<void> {
  const {
