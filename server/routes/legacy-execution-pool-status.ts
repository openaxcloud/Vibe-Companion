// AUTO-EXTRACTED from server/routes.ts (lines 4643-4653)
// Original section: execution-pool-status
...
export async function registerExecutionPoolStatusRoutes(app: Express, ctx: any): Promise<void> {
  const {
