// AUTO-EXTRACTED from server/routes.ts (lines 3693-3727)
// Original section: package-version-lookup
...
export async function registerPackageVersionLookupRoutes(app: Express, ctx: any): Promise<void> {
  const {
