// AUTO-EXTRACTED from server/routes.ts (lines 2306-2342)
// Original section: password-reset
...
export async function registerPasswordResetRoutes(app: Express, ctx: any): Promise<void> {
  const {
