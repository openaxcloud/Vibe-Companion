// AUTO-EXTRACTED from server/routes.ts (lines 3816-3856)
// Original section: system-modules
...
export async function registerSystemModulesRoutes(app: Express, ctx: any): Promise<void> {
  const {
