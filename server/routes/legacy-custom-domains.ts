// AUTO-EXTRACTED from server/routes.ts (lines 4585-4642)
// Original section: custom-domains
...
export async function registerCustomDomainsRoutes(app: Express, ctx: any): Promise<void> {
  const {
