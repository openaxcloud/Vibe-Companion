// AUTO-EXTRACTED from server/routes.ts (lines 2343-2373)
// Original section: email-verification
...
export async function registerEmailVerificationRoutes(app: Express, ctx: any): Promise<void> {
  const {
