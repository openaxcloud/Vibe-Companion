# Create a Slack-like real-time messaging — Project Guidelines
...
- `src/`
  ...
  - `lib/socket.ts`
  - `modules/app/App.tsx`
  - `modules/channels/ChannelPage.tsx`
  - `modules/direct/DmPage.tsx`
  - `modules/sidebar/Sidebar.tsx`
...
---
_Last auto-updated: 2026-04-17T05:02:41.923Z_
