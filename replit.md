...
- **AI Model Selector**: AIModelSelector supports inline/card/hero variants. AIPanel has built-in model switcher (GPT-4.1, Claude Sonnet 4, Gemini 2.5, etc.) with fallback chain. Agent panel passes through to AIPanel.
