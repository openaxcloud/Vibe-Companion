...
function getDeploymentUrl(): string | null {
  const appDomain = process.env.APP_DOMAIN || process.env.REPLIT_INTERNAL_APP_DOMAIN;
  if (appDomain) {
  ...
  const devDomain = process.env.ECODE_DEV_DOMAIN || process.env.REPLIT_DEV_DOMAIN;
  if (devDomain) {
