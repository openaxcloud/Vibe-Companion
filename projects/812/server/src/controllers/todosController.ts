/**
 * Controller functions interacting with Prisma to perform CRUD on Todo. Validates inputs with zod schemas, handles 404s, and returns standardized responses.
