/**
 * Express app factory that sets up JSON parsing, CORS, cookie parsing, and mounts API routers for auth, products, cart, checkout, and orders, as well as a base health route for readiness checks.
