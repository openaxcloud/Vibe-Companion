/**
 * Express error-handling middleware that formats application errors into consistent JSON responses with proper HTTP status codes and minimal leakage of internal details.
