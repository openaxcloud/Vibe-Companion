/**
 * Express middleware to verify JWT tokens from cookies or headers, attach the authenticated user to the request object, and optionally enforce protected routes for auth-required endpoints.
