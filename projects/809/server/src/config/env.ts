/**
 * Centralized environment configuration loader using dotenv that validates required env variables and exports a typed config object for use across the backend.
