/**
 * Seed script to create default admin user and sample products across categories with images and stock. Connect to PrismaClient and handle idempotency by upserting.
