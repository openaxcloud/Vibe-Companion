/**
 * Centralized environment variable parsing using zod. Validate presence of DATABASE_URL, JWT_SECRET, STRIPE keys, FRONTEND_URL, and PORT with sensible defaults in development.
