/**
 * Controller logic for registering new users (hash password), authenticating users (compare hash), issuing JWT, returning user DTOs, and clearing cookies on logout.
