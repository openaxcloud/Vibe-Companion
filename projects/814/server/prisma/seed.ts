/**
 * Seed script creating admin user, categories, products with images, and example users. Generates realistic prices and stock and a few orders for dashboard demonstration.
