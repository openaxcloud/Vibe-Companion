/**
 * Express app setup exporting configured app instance. Configure CORS with CLIENT_URL, JSON parsing, cookie-parser, and attach api router. Include 404 and error handlers.
