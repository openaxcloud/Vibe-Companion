/**
 * Ensure server startup uses the configured PORT, logs route base URL, and gracefully handles startup errors. Optionally add signal handlers for process termination in production.
