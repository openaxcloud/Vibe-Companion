/**
 * Reusable middleware to validate request bodies/query params using zod schemas for endpoints like chat message submission and document upload. Ensures API inputs are safe and well-typed.
