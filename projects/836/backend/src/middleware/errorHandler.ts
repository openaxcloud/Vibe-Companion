/**
 * Extend to differentiate between client (4xx) and server (5xx) errors, redact sensitive details, and include correlation IDs where applicable. Ensure consistent error response structure.
