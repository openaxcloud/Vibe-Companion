/**
 * Routes for listing existing conversations, fetching a conversation's messages, and possibly renaming or deleting conversations. Supports the frontend conversation sidebar and session restore.
