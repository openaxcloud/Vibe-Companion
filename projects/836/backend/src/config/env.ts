/**
 * Environment configuration module that loads .env using dotenv, validates required variables with zod (e.g., OPENAI_API_KEY, DATABASE_URL, NODE_ENV, PORT), and exports a strongly-typed config object for use across the backend.
