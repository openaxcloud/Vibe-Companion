/**
 * Optional seeding script to populate the database with a sample conversation and a demo document for testing RAG behavior during development. Demonstrates how to use the db client to insert records.
