/**
 * Document API helpers to upload files (multipart/form-data), list existing documents, fetch individual document details, and delete them. Abstracts away request construction and response typing.
