/**
 * Chat-specific API helpers for creating conversations, sending messages, and starting a streaming response via SSE. Uses shared types for ChatMessagePayload and returns structured data for the UI.
