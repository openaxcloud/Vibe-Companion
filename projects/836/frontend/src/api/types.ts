/**
 * Frontend representations of core API types (Conversation, Message, Document, UploadResponse, StreamEvent) aligned with backend contracts. Used throughout UI and API modules for type safety.
