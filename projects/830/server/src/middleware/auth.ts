/**
 * JWT auth middleware to verify tokens from Authorization header (Bearer) or cookies. Attaches userId and role to request object; provides requireAuth and requireAdmin.
