/**
 * Add register, login, logout, me, forgotPassword, resetPassword implementations with input validation, Prisma ops, password hashing, JWT issuing in secure cookies.
