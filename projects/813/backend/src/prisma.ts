/**
 * Singleton PrismaClient instance exported for reuse across route handlers, ensuring only one database client is created and managing clean shutdown behavior if needed.
