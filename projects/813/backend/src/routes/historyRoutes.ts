/**
 * Express router handling GET /history to return a list of recent calculations from the database, with optional query parameters for limit or sorting, providing data to display in the frontend history list.
