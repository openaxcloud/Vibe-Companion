/**
 * Express error-handling middleware that formats errors into consistent JSON responses with status codes and messages, ensuring backend errors don’t crash the server and are readable by the frontend.
