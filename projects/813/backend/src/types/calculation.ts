/**
 * TypeScript interfaces and type aliases representing the shape of calculation requests and responses, e.g., supported operator type union and CalculationDTO used by route handlers and for consistent typing across the backend.
