/**
 * Small API wrapper using fetch or axios to communicate with the backend, providing typed functions like calculate(operandA, operandB, operator) and getHistory() that return strongly-typed responses.
