/**
 * Type definitions mirroring the backend's CalculationDTO, request payload, operator union type, and response shapes to ensure type-safe interaction with the API across the app.
