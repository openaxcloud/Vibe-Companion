/**
 * Define TypeScript interfaces such as CounterState { value: number } and API response type aliases used in route handlers, centralizing type usage across backend layers for consistency.
