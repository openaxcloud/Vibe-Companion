/**
 * Seed script to create sample categories, products with images, and a demo user (hashed password). Uses PrismaClient and reads environment for salts/secrets.
