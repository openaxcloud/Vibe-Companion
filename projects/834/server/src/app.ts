/**
 * Creates an Express application, configures core middleware, sets up route modules (auth, products, cart, orders, stripe), and centralized error handler. Exports the app for testing.
