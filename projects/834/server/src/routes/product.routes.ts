/**
 * Defines GET /products with pagination, search, and filter by category and price; GET /products/:id; Admin POST/PUT/DELETE for product CRUD with isAdmin guard.
