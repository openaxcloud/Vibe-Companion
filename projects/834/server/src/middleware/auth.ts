/**
 * JWT authentication middleware to verify Authorization bearer token, attach user to request, and role-based guard helper (isAdmin). Handles missing/invalid token errors.
