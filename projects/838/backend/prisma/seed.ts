/**
 * Seed script connects to Prisma and inserts an admin user with hashed password and several sample products with various tags and prices, only if database is empty.
