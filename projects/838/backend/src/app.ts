/**
 * Creates Express app, applies CORS, JSON, cookie parsing, and route registration for auth, products, cart, orders, and payments. Adds global error handler middleware.
