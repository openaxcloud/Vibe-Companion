/**
 * Validates and exports configuration using zod. Loads environment variables and provides typed config for PORT, DATABASE_URL, JWT_SECRET, STRIPE keys, and CORS origins.
