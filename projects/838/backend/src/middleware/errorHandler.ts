/**
 * Express error-handling middleware that formats errors into standardized JSON responses. Distinguishes validation errors and hides internal details in production.
