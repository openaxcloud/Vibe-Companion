/**
 * Slice managing orders state including list of user's orders and possibly admin order overview. Includes thunks to fetch orders and order details from the backend.
