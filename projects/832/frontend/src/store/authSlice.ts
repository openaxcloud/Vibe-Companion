/**
 * Slice managing authentication state including current user, loading flags, and error messages. Contains async thunks for register, login, logout, and fetching the current user from /auth/me.
