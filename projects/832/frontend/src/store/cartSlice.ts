/**
 * Slice representing the client-side shopping cart with items, quantities, and computed totals. Provides actions to add, update, and remove items, and to clear the cart after successful checkout.
