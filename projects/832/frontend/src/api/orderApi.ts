/**
 * API functions for creating checkout payment intents, placing orders, and fetching order history or details. Works with Stripe-backed checkout flows implemented on the backend.
