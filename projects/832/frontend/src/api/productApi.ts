/**
 * API wrapper for product-related requests including listing with filters, search, and fetching product details. Accepts a filter object and serializes it into query parameters.
