/**
 * Axios instance configuration with baseURL pointing to the backend API, timeout, JSON headers, and withCredentials to send cookies. Optionally sets up response interceptors to handle auth errors globally.
