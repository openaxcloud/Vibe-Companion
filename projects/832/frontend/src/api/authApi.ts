/**
 * API wrapper functions for auth endpoints (register, login, logout, current user). Encapsulates request/response types and calls Axios client for actual HTTP operations.
