/**
 * Interfaces defining Product DTOs including ProductSummary, ProductDetail, and filter/search query types. Maps closely to Prisma Product model but refined for API contracts.
