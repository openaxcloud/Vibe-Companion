/**
 * Optional central index router that aggregates feature routers (auth, products, orders, payments) and exports a single root router for mounting in app.ts, providing a clear structure for API endpoints.
