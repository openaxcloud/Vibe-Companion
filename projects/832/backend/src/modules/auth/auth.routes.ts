/**
 * Express Router wiring auth endpoints to controllers and applying necessary middleware. Defines route paths and composes validation middleware using zod schemas.
