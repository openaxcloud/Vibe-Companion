/**
 * DTO and validation schemas for authentication flows, such as RegisterRequest, LoginRequest, and AuthResponse. Uses zod to validate request bodies for email, password, and optional name fields.
