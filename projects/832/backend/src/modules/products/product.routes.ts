/**
 * Express Router that registers public product endpoints for listing/search and viewing details, plus protected admin routes for managing products. Applies auth/role middleware where needed.
