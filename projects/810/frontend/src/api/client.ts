/**
 * HTTP client wrapping fetch with base URL from env (VITE_API_URL fallback) and helper methods for GET, POST, PATCH, DELETE with JSON handling and error normalization.
