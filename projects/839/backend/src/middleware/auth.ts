/**
 * JWT authentication middleware to protect routes. Parses Authorization header, verifies token, and attaches user info to request. Includes role-based guard for admin.
