/**
 * Environment loader using dotenv. Validates required environment variables with zod and exports typed config object (PORT, DATABASE_URL, JWT_SECRET, STRIPE keys).
