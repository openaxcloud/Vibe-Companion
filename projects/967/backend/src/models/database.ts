/**
 * SQLite database initialization with tables for recipes and ingredients. Includes functions to create tables with proper schema and seed data for testing.
