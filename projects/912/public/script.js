/**
 * Develop `script.js` to handle all frontend logic: fetching todos, rendering them, and handling user interactions (add, complete, delete) by communicating with the backend API.
