  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      read: false,
      user: { name: 'Sarah Chen', avatar: 'https://ui-avatars.com/api/?background=F26207&color=fff&name=Sarah%20Chen/40' },
    },
    {
      id: '2',
      type: 'like',
    ...
    },
    {
      ...
      read: true,
      user: { name: 'Alex', avatar: 'https://ui-avatars.com/api/?background=F26207&color=fff&name=Alex/40' },
