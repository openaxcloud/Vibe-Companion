...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed left-0 right-0 z-[9999] p-3 bg-[var(--ide-panel)] border-t border-[var(--ide-border)] shadow-lg bottom-[64px] sm:bottom-0 rounded-t-xl sm:rounded-none mx-2 sm:mx-0 pointer-events-auto" data-testid="cookie-consent">
