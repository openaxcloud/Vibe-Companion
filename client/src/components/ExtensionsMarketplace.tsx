...
const AVAILABLE_EXTENSIONS: Extension[] = [
  ...
  { id: "terminal-tabs", name: "Terminal Tabs", description: "Enhanced terminal with tabs, split panes, and custom profiles", icon: Terminal, category: "Tools", version: "1.8.0", author: "E-Code", downloads: "5M", rating: 4.2, color: "#22C55E" },
