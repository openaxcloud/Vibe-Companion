...
import { Code2, Github, Mail, Sparkles, Zap } from "lucide-react";
    ...
    <div className="h-full flex flex-col p-6 bg-gradient-to-br from-background via-background to-primary/5 relative">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full z-10">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                {isLogin && <span className="text-xs text-primary cursor-pointer hover:underline">Forgot?</span>}
              </div>
              <Input 
                id="password" 
                type="password" 
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 rounded-xl bg-background/50 border-white/10 hover:bg-background/80"
            type="button"
