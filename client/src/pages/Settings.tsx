...
export default function Settings() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#0d1117] text-[#c9d1d9]">
      <div className="flex items-center gap-3 px-4 sm:px-8 py-4 bg-[#161b22] border-b border-[#30363d] shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-8">
        <div className="max-w-lg mx-auto space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="rounded-xl bg-[#161b22] border border-[#30363d]">
          ...
          <div className="space-y-2">
            ...
            <div className="rounded-xl bg-[#161b22] border border-[#30363d] divide-y divide-[#30363d]">
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#30363d] flex items-center justify-center"><Bell className="w-4 h-4 text-blue-400" /></div>
              ...
              <div className="flex items-center justify-between p-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#30363d] flex items-center justify-center"><Smartphone className="w-4 h-4 text-green-400" /></div>
          ...
          <div className="space-y-2">
            <div className="rounded-xl bg-[#161b22] border border-[#30363d] divide-y divide-[#30363d]">
              <div className="flex items-center justify-between p-4 cursor-pointer hover:bg-[#1c2128] transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#30363d] flex items-center justify-center"><Shield className="w-4 h-4 text-purple-400" /></div>
