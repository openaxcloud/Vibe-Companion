    ...
    <div className="h-screen flex flex-col bg-[var(--ide-panel)] text-sm select-none">
      <div className="flex items-center justify-between px-2 h-10 bg-[var(--ide-panel)] border-b border-[var(--ide-border)] shrink-0">
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="icon" className="w-7 h-7 text-[var(--ide-text-secondary)] hover:text-white hover:bg-[var(--ide-surface)]" onClick={() => setLocation("/")} data-testid="button-back-shared">
          ...
          <span className="text-xs font-semibold text-[var(--ide-text)] truncate max-w-[140px]">{data?.project.name}</span>
        ...
        <div className="flex items-center gap-2">
          <Button
            size="sm"
            variant="ghost"
            className="h-7 px-3 text-xs font-medium rounded-md gap-1.5 text-[var(--ide-text-secondary)] hover:text-[var(--ide-text)] hover:bg-[var(--ide-surface)] border border-[var(--ide-border)]"
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          <div className="h-[200px] border-t border-[var(--ide-border)] flex flex-col shrink-0">
