...
const faqs: FaqItem[] = [
  ...
  { category: "Billing", question: "How does AI billing work?", answer: "AI usage is billed per token. GPT-4.1 costs $0.002 per 1K tokens, Claude Sonnet 4 costs $0.003 per 1K tokens, and Gemini 2.5 Flash costs $0.00004 per 1K tokens. Your current usage is shown in Settings > Usage." },
