...
export default function Dashboard() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#0E1525] text-[#F5F9FC]">
      <header className="flex items-center justify-between px-4 sm:px-5 h-12 bg-[#0E1525] border-b border-[#2B3245]/60 shrink-0 z-10">
        ...
        <div className="flex items-center gap-2">
          <Link href="/demo">
            <Button variant="ghost" size="sm" className="h-8 text-[11px] text-[#9DA2B0] hover:text-[#F5F9FC] hover:bg-[#2B3245] gap-1.5 hidden sm:flex rounded-lg" data-testid="button-demo">
              <Eye className="w-3.5 h-3.5" /> Demo
            </Button>
          </Link>
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger asChild>
              <Button size="sm" className="h-8 bg-[#0079F2] hover:bg-[#0066CC] text-white text-[11px] rounded-lg gap-1.5 font-medium px-3.5 shadow-sm shadow-[#0079F2]/20" data-testid="button-new-project">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-[680px] mx-auto px-4 sm:px-6">
          <div className="pt-16 sm:pt-24 pb-8 text-center">
            <h1 className="text-[28px] sm:text-[36px] font-bold text-[#F5F9FC] mb-3 tracking-tight leading-tight" data-testid="text-hero-title">What will you create?</h1>
            <p className="text-[13px] text-[#676D7E] max-w-md mx-auto leading-relaxed">Describe your idea and AI will build it for you, or start from a template</p>
          </div>

          <form onSubmit={handleGenerateSubmit} className="mb-12">
              ...
              <div className="flex items-center justify-between px-3 pb-3">
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className={`flex items-center gap-1 text-[10px] px-2.5 py-1.5 rounded-md transition-all font-medium ${aiModel === "claude" ? "bg-[#7C65CB]/15 text-[#A78BFA] border border-[#7C65CB]/30" : "text-[#676D7E] border border-transparent hover:text-[#9DA2B0] hover:bg-[#2B3245]/50"}`}
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 text-[10px] px-2.5 py-1.5 rounded-md transition-all font-medium ${aiModel === "gpt" ? "bg-[#0CCE6B]/15 text-[#0CCE6B] border border-[#0CCE6B]/30" : "text-[#676D7E] border border-transparent hover:text-[#9DA2B0] hover:bg-[#2B3245]/50"}`}
                ...
                <Button
                  type="submit"
                  size="sm"
                  className="h-8 px-4 bg-[#0CCE6B] hover:bg-[#0AB85E] text-[#0E1525] rounded-lg text-[11px] font-semibold gap-1.5 shadow-sm shadow-[#0CCE6B]/20"
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5" ref={templatesRef}>
              {TEMPLATES.map((tmpl) => (
                <button
                  key={tmpl.name}
                  className={`relative flex flex-col items-start gap-3 p-3.5 rounded-xl border ${tmpl.borderColor} bg-[#1C2333] transition-all text-left group active:scale-[0.98] overflow-hidden`}
          ...
          <div className="pb-8">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-[11px] font-semibold text-[#676D7E] uppercase tracking-wider" data-testid="text-my-repls">My Repls</h3>
              <div className="flex items-center gap-2">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-7.5 bg-[#0E1525] border-[#2B3245] h-7 w-40 text-[11px] rounded-md text-[#F5F9FC] placeholder:text-[#676D7E] focus-visible:ring-1 focus-visible:ring-[#0079F2]/40"
              ...
              <div className="border border-[#2B3245]/50 rounded-xl overflow-hidden bg-[#1C2333]/20">
                {projects.map((project, idx) => {
                  ...
                  return (
                    <div
                      key={project.id}
                      className={`flex items-center gap-3 px-3.5 py-2.5 hover:bg-[#1C2333]/80 cursor-pointer transition-all group ${idx !== 0 ? "border-t border-[#2B3245]/30" : ""}`}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          ...
                          <span className="text-[8px] text-[#323B4F]">•</span>
      ...
      <footer className="px-4 py-2.5 border-t border-[#2B3245]/40 bg-[#0E1525] flex items-center justify-center shrink-0">
        <div className="flex items-center gap-2 text-[10px] text-[#676D7E]/60">
          <svg width="12" height="12" viewBox="0 0 32 32" fill="none" className="opacity-40">
