...
export default function Dashboard() {
  ...
  return (
    <div className="h-full flex flex-col bg-[#0d1117] text-[#c9d1d9]">
      {/* Header */}
      <div className="px-4 pt-10 pb-4 bg-[#161b22] border-b border-[#30363d]">
        ...
        <div className="px-4 py-3 flex gap-2">
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger asChild>
              <button className="flex-1 flex items-center gap-2 p-3 rounded-xl bg-[#161b22] border border-[#30363d] hover:border-[#58a6ff]/50 transition-colors" data-testid="button-new-project">
            ...
            <DialogContent className="bg-[#1c2128] border-[#30363d] rounded-xl max-w-sm">
              <DialogHeader>
              ...
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  if (newProjectName.trim()) createProject.mutate({ name: newProjectName.trim(), language: newProjectLang });
                }}
                className="space-y-4 mt-2"
              >
                <div className="space-y-1">
                  <Label className="text-[11px] text-[#8b949e]">Project Name</Label>
                  <Input
                    value={newProjectName}
                    onChange={(e) => setNewProjectName(e.target.value)}
                    placeholder="my-awesome-app"
                    className="bg-[#0d1117] border-[#30363d] h-10 rounded-lg text-[#c9d1d9]"
                    required
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium border transition-colors ${
                            newProjectLang === lang ? info.color : "bg-[#30363d]/50 text-[#8b949e] border-transparent hover:border-[#484f58]"
                          }`}
          ...
          <Link href="/demo" className="flex-1">
            <button className="w-full flex items-center gap-2 p-3 rounded-xl bg-[#161b22] border border-[#30363d] hover:border-[#58a6ff]/50 transition-colors">
        ...
        <div className="px-4 pb-4">
          ...
          {projectsQuery.isLoading ? (
            ...
            <div className="text-center py-12">
              <Folder className="w-10 h-10 mx-auto mb-3 text-[#30363d]" />
              ...
              {projects.map((project, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-3 rounded-xl bg-[#161b22] border border-[#30363d] hover:border-[#484f58] cursor-pointer active:scale-[0.99] transition-all"
                  ...
                  >
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-44 bg-[#1c2128] border-[#30363d] rounded-lg">
      ...
      {/* Footer */}
      <div className="px-4 py-2 border-t border-[#30363d] bg-[#161b22] flex items-center justify-center">
