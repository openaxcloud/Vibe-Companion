    ...
    <div className="min-h-screen bg-[#0E1525] text-[#F5F9FC]">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-[#9DA2B0] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">6. Subscription Plans & Billing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">7. Service Availability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">9. Termination</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">10. Changes to Terms</h2>
