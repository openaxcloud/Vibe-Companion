      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-[var(--ide-panel)] border border-[var(--ide-border)] rounded-xl">
          ...
          <div className="divide-y divide-[var(--ide-border)]">
            <div className="grid grid-cols-[1fr_1fr_100px_80px_60px] gap-4 px-4 py-2 text-xs font-medium text-[var(--ide-text-muted)] uppercase tracking-wider">
            ...
            {usersQuery.isLoading ? (
              ...
              <div key={u.id} className="grid grid-cols-[1fr_1fr_100px_80px_60px] gap-4 px-4 py-3 items-center hover:bg-[var(--ide-bg)]/30" data-testid={`user-row-${u.id}`}>
                ...
                <span className={`text-xs ${u.emailVerified ? 'text-[#0CCE6B]' : 'text-[var(--ide-text-muted)]'}`}>{u.emailVerified ? "Yes" : "No"}</span>
