...
import {
  ...
  X, Trash2, Pencil, FolderOpen, Settings, MoreHorizontal, PanelRightClose,
  File as FileIcon, RefreshCw, Sparkles, Globe, Rocket, ChevronRight
} from "lucide-react";
...
export default function Project() {
  ...
  const openFile = (file: File) => {
    ...
    if (!fileContents[file.id]) setFileContents((prev) => ({ ...prev, [file.id]: file.content }));
    ...
    <div className="h-screen flex flex-col bg-[#0d1117] text-sm select-none">
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      ...
                      if (!fileContents[tabId]) setFileContents((prev) => ({ ...prev, [tabId]: file.content }));
                    }}
      ...
      <Dialog open={newFileDialogOpen} onOpenChange={setNewFileDialogOpen}>
        <DialogContent className="bg-[#1c2128] border-[#30363d] rounded-xl sm:max-w-sm">
          <DialogHeader><DialogTitle className="text-[#c9d1d9] text-base">New File</DialogTitle></DialogHeader>
      ...
      <Dialog open={projectSettingsOpen} onOpenChange={setProjectSettingsOpen}>
        <DialogContent className="bg-[#1c2128] border-[#30363d] rounded-xl sm:max-w-sm">
          <DialogHeader><DialogTitle className="text-[#c9d1d9] text-base">Project Settings</DialogTitle></DialogHeader>
