  ...
  return (
    <div className="min-h-screen bg-[#0E1525] text-[#F5F9FC]">
      <div className="max-w-3xl mx-auto px-6 py-12">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-[#9DA2B0] hover:text-[#F5F9FC] mb-8 transition-colors" data-testid="link-back">
          <ArrowLeft className="w-4 h-4" /> Back
        </Link>

        <h1 className="text-3xl font-bold mb-2" data-testid="text-privacy-title">Privacy Policy</h1>
        <p className="text-sm text-[#676D7E] mb-8">Last updated: March 10, 2026</p>

        <div className="prose prose-invert max-w-none space-y-6 text-[#9DA2B0] text-sm leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">1. Information We Collect</h2>
            <p>We collect information you provide directly when using our Service:</p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li><strong className="text-[#F5F9FC]">Account Information:</strong> Email address, display name, and password (hashed)</li>
              <li><strong className="text-[#F5F9FC]">Project Data:</strong> Code, files, and project configurations you create</li>
              <li><strong className="text-[#F5F9FC]">Usage Data:</strong> Code execution logs, AI interactions, and feature usage patterns</li>
              <li><strong className="text-[#F5F9FC]">Connected Accounts:</strong> GitHub account information when you connect your account</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">3. Data Storage & Security</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">4. AI & Code Processing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">5. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">6. Your Rights (GDPR)</h2>
            <p>You have the right to:</p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li><strong className="text-[#F5F9FC]">Access:</strong> Export all your data via Settings</li>
              <li><strong className="text-[#F5F9FC]">Rectification:</strong> Update your profile information at any time</li>
              <li><strong className="text-[#F5F9FC]">Erasure:</strong> Delete your account and all associated data</li>
              <li><strong className="text-[#F5F9FC]">Portability:</strong> Download your data in JSON format</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">7. Cookies</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">8. Data Retention</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#F5F9FC] mb-3">9. Changes to This Policy</h2>
